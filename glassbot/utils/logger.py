...
def _setup_root_logger() -> None:
    ...
    try:
        # Import here (not at module top) to avoid circular imports; config.py
        # does not import logger.py, but other modules might import both.
        from glassbot import config as _config_module  # type: ignore[attr-defined]
...
def get_logger(component: str) -> logging.Logger:
    ...
    Usage::
        ...
        from glassbot.utils.logger import get_logger
